  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Clases Recientes</h3>
          ...
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-medium text-gray-900">Matemáticas {item}</p>
                  <p className="text-sm text-gray-500">Grupo A - 08:00 AM</p>
                </div>
              </div>
